    ...
    {status, body} =
      case conn.body_params do
        %{"div" => div, "season" => season} ->
          ...
          proto = Derivico.Api.Encoder.data_to_proto(data)
          {200, proto}
        _ ->
          {200, Derivico.Api.Encoder.data_to_proto([])}
      end

    send_resp(conn, status, Derivico.Api.Encoder.encode(body))
  end
...
defmodule Derivico.Api.Encoder do
